        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
           {popularItems.map((item, index) => (
            <Card
              key={item.id}
              hoverable
              className="shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 border-0 rounded-3xl relative group bg-white"
              cover={
                <div className="relative h-56 overflow-hidden rounded-t-3xl group">
                   ...
                   {/* Popular Badge - Bottom Center */}
                   {index < 2 && (
                     <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-red-500 to-pink-500 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg animate-pulse">
                       🔥 Most Popular
                     </div>
                   )}
                 </div>
             ...
             >
               <div className="space-y-3">
                 <div>
                   <Title level={4} className="mb-1 text-lg font-bold text-gray-900 hover:text-red-600 transition-colors duration-300">
                     {item.name}
                   </Title>
                 ...
                 <div className="flex flex-wrap gap-1">
                   {item.isVegetarian && (
                     <div className="inline-flex items-center space-x-1 bg-green-50 text-green-700 px-2 py-1 rounded-full text-xs font-medium border border-green-200">
                   ...
                   {item.isSpicy && (
                     <div className="inline-flex items-center space-x-1 bg-red-50 text-red-700 px-2 py-1 rounded-full text-xs font-medium border border-red-200">
                       <span className="text-sm">🔥</span>
                       <span>Spicy</span>
                     </div>
                   )}
                 ...
                 <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                   ...
                   <Button
                     ...
                     className="bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 border-none font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                   >
                     Add
                   </Button>
                 </div>
